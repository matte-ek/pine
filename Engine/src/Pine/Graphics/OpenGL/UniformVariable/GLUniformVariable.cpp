...
void Pine::Graphics::GLUniformVariable::LoadVector2(const Pine::Vector2f& value)
{
    glUniform2f(m_Id, value.x, value.y);
}

void Pine::Graphics::GLUniformVariable::LoadVector3(const Pine::Vector3f& value)
{
    glUniform3f(m_Id, value.x, value.y, value.z);
}

void Pine::Graphics::GLUniformVariable::LoadVector4(const Pine::Vector4f& value)
{
    glUniform4f(m_Id, value.x, value.y, value.z, value.w);
}

void Pine::Graphics::GLUniformVariable::LoadVector2(const Pine::Vector2i& value)
{
    glUniform2i(m_Id, value.x, value.y);
}

void Pine::Graphics::GLUniformVariable::LoadVector3(const Pine::Vector3i& value)
{
    glUniform3i(m_Id, value.x, value.y, value.z);
}

void Pine::Graphics::GLUniformVariable::LoadVector4(const Pine::Vector4i& value)
{
    glUniform4i(m_Id, value.x, value.y, value.z, value.w);
}

void Pine::Graphics::GLUniformVariable::LoadMatrix4(const Pine::Matrix4f& value)
{
