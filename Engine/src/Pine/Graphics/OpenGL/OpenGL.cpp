...
namespace
{
	...
	std::uint32_t TranslateBlendingFunction(Pine::Graphics::BlendingFunction blendingFunction)
	{
		...
		{
		case Pine::Graphics::BlendingFunction::Zero:
			return GL_ZERO;
		case Pine::Graphics::BlendingFunction::One:
			return GL_ONE;
		case Pine::Graphics::BlendingFunction::SourceColor:
			return GL_SRC_COLOR;
		case Pine::Graphics::BlendingFunction::OneMinusSourceColor:
			return GL_ONE_MINUS_SRC_COLOR;
		case Pine::Graphics::BlendingFunction::DestinationColor:
			return GL_DST_COLOR;
		case Pine::Graphics::BlendingFunction::OneMinusDestinationColor:
			return GL_ONE_MINUS_DST_COLOR;
		case Pine::Graphics::BlendingFunction::SourceAlpha:
			return GL_SRC_ALPHA;
		case Pine::Graphics::BlendingFunction::OneMinusSourceAlpha:
			return GL_ONE_MINUS_SRC_ALPHA;
		case Pine::Graphics::BlendingFunction::DestinationAlpha:
			return GL_DST_ALPHA;
		case Pine::Graphics::BlendingFunction::OneMinusDestinationAlpha:
			return GL_ONE_MINUS_DST_ALPHA;
		case Pine::Graphics::BlendingFunction::ConstantColor:
			return GL_CONSTANT_COLOR;
		case Pine::Graphics::BlendingFunction::OneMinusConstantColor:
			return GL_ONE_MINUS_CONSTANT_COLOR;
		case Pine::Graphics::BlendingFunction::ConstantAlpha:
			return GL_CONSTANT_ALPHA;
		case Pine::Graphics::BlendingFunction::OneMinusConstantAlpha:
			return GL_ONE_MINUS_CONSTANT_ALPHA;
		case Pine::Graphics::BlendingFunction::SourceAlphaSaturate:
...
void Pine::Graphics::OpenGL::ResetInternalChangeTracking()
{
	GLTexture::ResetChangeTracking();
	GLShaderProgram::ResetChangeTracking();
	GLUniformBuffer::ResetChangeTracking();
}
