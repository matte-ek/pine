...
// Spot lights occupy instance light slots 5-6; their directions are vIn.lightDir[6..7].
...
void main(void)
{
    ...
    // Distance fog, exactly as the generic shader applies it. fogSettings.x = view distance,
    // fogSettings.y = intensity (0 disables it).
